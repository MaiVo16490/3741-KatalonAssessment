...
class TestListener {
	...
	def sampleBeforeTestCase(TestCaseContext testCaseContext) {		
		...
		// Check if the test case name contains 'Delete'
...
println("Login successfully validated for email: ${GlobalVariable.newEmail}")
		...
		} else if (!testCaseName.contains('Login') && !testCaseName.contains('SignUp')) {
			// Regular flow for other test cases (not Delete, Login, or SignUp)
